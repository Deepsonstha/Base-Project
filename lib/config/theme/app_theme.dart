import 'package:base_project/config/theme/app_color.dart';
import 'package:base_project/config/theme/app_textstyles.dart';
...
class AppTheme {
  ...
  static ThemeData dark = ThemeData(
    ...
    primaryColor: AppColor.backgroundDarkColor,
    textTheme: TextTheme(
    ...
    // colorScheme: ColorScheme.fromSwatch(primarySwatch: AppColor.primarySwatch, brightness: Brightness.dark),
    elevatedButtonTheme: const ElevatedButtonThemeData(
        style: ButtonStyle(
