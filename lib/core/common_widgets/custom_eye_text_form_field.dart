...
class CustomEyeTextFormField extends StatefulWidget {
  ...
  @override
  State<CustomEyeTextFormField> createState() => _CustomEyeTextFormFieldState();
}

class _CustomEyeTextFormFieldState extends State<CustomEyeTextFormField> {
